...
const int EMPTY_FND = -1;
const string NO_FDBLS = "You currently have not defeated any foundables.";
const string WIN = "You've beaten the foundable!";
const string LOSS = "You did not beat the foundable.";
