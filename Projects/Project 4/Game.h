...
const int CHARACTER_HEALTH = 10; //starting character health
//******************************************************

const int FIRST_CLASS = 1;
const int LAST_CLASS  = 4;

const string BB_DRAGON_NAME = "Baby Dragon";
const string GOBLIN_NAME = "Goblin";
const string SKELETON_NAME = "Skeleton";
